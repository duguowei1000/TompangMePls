...
export const testMenu = new Composer();
//Parameters
...
// const testMenu = new Bot<MyContext>(botToken);
// testMenu.use(session({
//     initial(): SessionData {
//         return { favoriteIds: [] };
//     },
// }));
...
testMenu.use(mainMenu);
testMenu.command("start", (ctx) => ctx.reply(mainText, { reply_markup: mainMenu }));
testMenu.command("help", async (ctx) => {
    const text = "Send /start to see and rate dishes. Send /fav to list your favorites!";
    await ctx.reply(text);
});
testMenu.command("fav", async (ctx) => {
...
testMenu.catch(console.error.bind(console));
///////////////////////////////////////////////////////////////////////TESTING
// testMenu.command("add", (ctx) => {
//     // `item` will be 'apple pie' if a user sends '/add apple pie'.
//     const item = ctx.match;
//     console.log(item)
//   });
// testMenu.command("menu", (ctx) => {
// // `item` will be 'apple pie' if a user sends '/add apple pie'.
// const msgtext = ctx.msg.text;
// console.log(msgtext)
// });
// testMenu.command("start", (ctx) => ctx.reply("Hello there!"));
